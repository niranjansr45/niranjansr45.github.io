...
const PaymentForm = () => {
  ...
  const handlePayment = async (params) => {
    ...
    if (
      ...
      //checkout order
      axios
        .post("https://analyze.flipwhatsapp.com/api/v1/checkout_order", article)
        .then((response) => {
      ...
      const options = {
        ...
        handler: function (response) {
          ...
          axios
            .post(
              `https://analyze.flipwhatsapp.com/api/v1/checkout_order_update/${orderId}`,
              stat
            )
            .then((response) => {
        ...
        >
          ...
          <form className="cardDetails">
            ...
            <input
              type="text"
              className="phone"
              placeholder="Enter Number ex:919888888889"
            />
            <input
              type="text"
              className="address"
          ...
          <div className="buttons">
            <button
              className="cancel"
              onClick={() => {
                navigate("/analysed", { state: location.state });
              }}
            >
              Cancel
            </button>
